...
var updateWeather = function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            html = '<div id="weather-icon" width="128" height="128"><i class="owf owf-5x owf-'+data.weather[0].id+'-'+nightorday+'"></i></div><h2> '+Math.ceil(data.main.temp)+'&deg;</h2>';
            html += '<div id="region">'+data.name+'</div>';
